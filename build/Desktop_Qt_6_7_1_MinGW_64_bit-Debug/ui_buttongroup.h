...
public:
    ...
    void setupUi(QWidget *ButtonGroup)
    {
        ...
        horizontalSpacer_2 = new QSpacerItem(302, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_2);

        stackedWidget->addWidget(startpage);
        play_card_page = new QWidget();
        play_card_page->setObjectName("play_card_page");
        horizontalLayout_3 = new QHBoxLayout(play_card_page);
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        horizontalSpacer_3 = new QSpacerItem(302, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_4 = new QSpacerItem(302, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_5 = new QSpacerItem(46, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_7 = new QSpacerItem(227, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        horizontalLayout_4->addItem(horizontalSpacer_7);

        stackedWidget->addWidget(PlayOrPassPage);
        Call_Lord_Page = new QWidget();
        Call_Lord_Page->setObjectName("Call_Lord_Page");
        horizontalLayout_5 = new QHBoxLayout(Call_Lord_Page);
        horizontalLayout_5->setObjectName("horizontalLayout_5");
        horizontalSpacer_8 = new QSpacerItem(55, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_11 = new QSpacerItem(40, 10, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_9 = new QSpacerItem(55, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
